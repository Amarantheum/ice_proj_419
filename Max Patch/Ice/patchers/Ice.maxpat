...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 622.25, 127.0, 51.0, 22.0 ],
					"text" : "s fxgate"
				}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 60.0, 53.0, 139.0, 22.0 ],
													"text" : "gate~ 3"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 725.5, 215.5, 90.0, 77.0 ],
													"text" : ";\r\nharmOnOff 1;\r\nchorusOnOff 0;\r\n"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 543.0, 215.5, 90.0, 77.0 ],
													"text" : ";\r\nchorusOnOff 1;\r\nharmOnOff 0;\r\n"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 612.0, 79.0, 124.0, 22.0 ],
													"text" : "route 8 13"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 612.0, 46.0, 54.0, 22.0 ],
													"text" : "r cCount"
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 189.5, 83.0, 302.5, 83.0 ],
													"source" : [ "obj-3", 2 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-5", 0 ],
													"midpoints" : [ 129.5, 87.0, 64.5, 87.0 ],
													"source" : [ "obj-3", 1 ]
												}
...
,
									"patching_rect" : [ 121.5, 250.0, 72.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 121.5, 189.0, 66.0, 22.0 ],
									"text" : "r noiseRes"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 121.5, 217.0, 192.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 356.0, 313.5, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 131.0, 285.0, 365.5, 285.0 ],
									"source" : [ "obj-24", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 31.5, 163.0, 365.5, 163.0 ],
									"source" : [ "obj-45", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 164.0, 164.0, 365.5, 164.0 ],
									"source" : [ "obj-5", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 436.5, 164.0, 365.5, 164.0 ],
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 298.5, 164.0, 365.5, 164.0 ],
									"source" : [ "obj-7", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 572.5, 165.0, 365.5, 165.0 ],
									"source" : [ "obj-9", 0 ]
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 87.5, 180.0, 141.5, 180.0 ],
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 248.5, 100.0, 321.5, 100.0 ],
									"source" : [ "obj-6", 2 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 808.0, 105.0, 150.0, 34.0 ],
					"presentation" : 1,
